...
<div class="topbar">
  ...
  <div class="actions">
    <a class="btn btn-secondary btn-sm" href="<?= e(url('admin/travels.php')) ?>">Add travel</a>
    <a class="btn btn-sm" href="<?= e(url('admin/emails.php')) ?>">Send email</a>
  </div>
</div>
...
<div class="panel">
  <div class="panel-head"><h2>Recent client requests</h2><a href="<?= e(url('admin/requests.php')) ?>">View all</a></div>
  <div class="table-wrap">
    <table>
      ...
      <?php foreach ($recentRequests as $r): ?>
        <tr>
          <td><a href="<?= e(url('admin/requests.php?id=<?= (int)$r['id'] ?>')) ?>"><?= e($r['name']) ?></a><div class="help"><?= e($r['email']) ?></div></td>
          <td><?= e($r['subject'] ?: '—') ?></td>
...
<div class="panel">
  <div class="panel-head"><h2>Recent bookings</h2><a href="<?= e(url('admin/bookings.php')) ?>">Manage</a></div>
  <div class="table-wrap">
    <table>
      ...
      <?php foreach ($recentBookings as $b): ?>
        <tr>
          <td><a href="<?= e(url('admin/bookings.php?id=<?= (int)$b['id'] ?>')) ?>"><?= e($b['tracking_code']) ?></a></td>
...
<div class="panel">
  <div class="panel-head"><h2>Activity</h2><a href="<?= e(url('admin/logs.php')) ?>">Full log</a></div>
  <div class="table-wrap">
    <table>
