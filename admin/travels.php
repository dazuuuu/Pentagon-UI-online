...
<div class="panel">
  <div class="panel-head"><h2><?= $edit ? 'Edit travel' : 'Add travel' ?></h2><?php if ($edit): ?><a href="/admin/travels.php">Cancel</a><?php endif; ?></div>
    ...
    <table>
      ...
      <?php foreach ($rows as $r): ?>
        <tr>
          ...
          <td class="actions">
            <a class="btn btn-secondary btn-sm" href="/admin/travels.php?edit=<?= (int)$r['id'] ?>">Edit</a>
